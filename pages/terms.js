      ...
      <main className={styles.main}>
        <div className="container">
          ...
          <p>
            ...
            use of Lemonraise&apos;s Website, located at lemonraise.com.
          </p>
          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Lemonraise if you do not agree to
          ...
          <h3>Cookies</h3>
          <p>
            We employ the use of cookies. By accessing Lemonraise, you agreed to
            use cookies in agreement with the Lemonraise&apos;s Privacy Policy.
          </p>
          <p>
          ...
          <h3>License</h3>
          <p>
            Unless otherwise stated, Lemonraise and/or its licensors own the
            intellectual property rights for all material on Lemonraise. All
            intellectual property rights are reserved. You may access this from
            Lemonraise for your own personal use subjected to restrictions set
            in these terms and conditions.
          </p>
          <p>You must not:</p>
          <ul>
            <li>Republish material from Lemonraise</li>
            <li>Sell, rent or sub-license material from Lemonraise</li>
            <li>Reproduce, duplicate or copy material from Lemonraise</li>
            <li>Redistribute content from Lemonraise</li>
          </ul>
          <p>
          ...
          <p>
            ...
            Lemonraise does not filter, edit, publish or review Comments prior
            to their presence on the website. Comments do not reflect the views
            and opinions of Lemonraise,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views
            and opinions. To the extent permitted by applicable laws, Lemonraise
          ...
          <p>
            Lemonraise reserves the right to monitor all Comments and to remove
          ...
          <ul>
            ...
            <li>
              You hereby grant Lemonraise a non-exclusive license to use,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Lemonraise;
          ...
          <p>
            ...
            sending an e-mail to Lemonraise. Please include your name, your
          ...
          <ul>
            ...
            <li>
              No use of Lemonraise&apos;s logo or other artwork will be allowed
